...
public class PendingOrders {
     ...
     */
    public ResultSet getPendingOrders(String columnsNeeded){
        try{
     ...
     */
    public int insertPendingOrders(int farmer_id, int order_number, String description, String futures_contract, String quantity, int strike, double cost_per_ton, Timestamp timestamp){
        int result=0;
        try{
     ...
     * @return 1 if success, 0 if fail.
     */
    public int deletePendingOrders(int order_Number){
        int result = 0;
        try{
